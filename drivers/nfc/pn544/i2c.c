...
#define PN544_HW_VERSION_C2 0x02
#define PN544_HW_VERSION_C3 0x03
...
static void pn544_hci_i2c_fw_work(struct work_struct *work)
{
	...
	case FW_WORK_STATE_START:
		...
		switch (phy->hw_version) {
		case PN544_HW_VERSION_C2:
